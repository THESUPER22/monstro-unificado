...
def rodar_backtest_m5_wdo():
    ...
    for dia_atual in dias:
        ...
        try:
            ...
            sl_preco = (low_m5 - 5) if direcao == "BUY" else (high_m5 + 5)
            ...
            lucro_1to1 = (pts_1to1 * valor_ponto_wdo * contratos) - custo_total_trade

            pts_2to1 = (preco_saida_2to1 - preco_entrada) if direcao == "BUY" else (preco_entrada - preco_saida_2to1)
            lucro_2to1 = (pts_2to1 * valor_ponto_wdo * contratos) - custo_total_trade
    ...
    print("\n==================================================")
    print(f"BACKTEST ABERTURA M5 (09:00-09:05) - WDO")
    print("==================================================")
