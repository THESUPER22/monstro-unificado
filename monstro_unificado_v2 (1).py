    ...
    for encoding in ['utf-16-le', 'utf-8', 'utf-16', 'latin1']:
        try:
            ...
            try:
                ...
                # 7. Validação extra: verifica campos do EA v4.1
                # EA v4.1 usa: timestamp, symbol, bids, asks, total_bid_volume, total_ask_volume
                # EA antigo usava: metadata (campo removido no v4.1)
                # Aceita ambos os formatos — só precisa ter bids e asks válidos (já verificado acima)
