...
# Entropia alta para modo explosão (aumentado de 0.7 para 0.8)
THRESHOLD_ENTROPIA_ALTA = 0.8
# Mínimo crescimento de volume para modo explosão (reduzido de 1.5 para 1.2)
MIN_VOLUME_CRESCIMENTO = 1.2
